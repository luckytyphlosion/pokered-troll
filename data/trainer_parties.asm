...
Green3Data:
	db $FE
	db 61,CHARIZARD,FIRE_SPIN,FIRE_BLAST,SLASH,FISSURE
	db 59,RATICATE,BODY_SLAM,THUNDERBOLT,ICE_BEAM,DIG
	db 61,CLEFABLE,BODY_SLAM,THUNDERBOLT,ICE_BEAM,PSYCHIC
	db 61,NIDOQUEEN,HORN_DRILL,THUNDERBOLT,ICE_BEAM,EARTHQUAKE
	db 63,BLASTOISE,SURF,ICE_BEAM,MEGA_KICK,FISSURE
	db 65,NIDOKING,HORN_DRILL,THUNDERBOLT,ICE_BEAM,EARTHQUAKE
	db 0
LoreleiData:
